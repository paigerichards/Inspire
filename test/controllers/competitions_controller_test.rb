...
class CompetitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post competitions_url, params: { competition: { company: @competition.company, date: @competition.date, date_drawn: @competition.date_drawn, description: @competition.description, title: @competition.title, user_id: @competition.user_id } }
    end
  ...
  test "should update competition" do
    patch competition_url(@competition), params: { competition: { company: @competition.company, date: @competition.date, date_drawn: @competition.date_drawn, description: @competition.description, title: @competition.title, user_id: @competition.user_id } }
